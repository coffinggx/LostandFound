...
const ReportFound = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      formPayload.append('item_type', 'found');
      ...
      setError(err.message || 'Unable to report found item right now.');
      showToast(err.message || 'Unable to report found item right now.', 'error');
    } finally {
      ...
      <div className="report-card found-card">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-actions">
            <button type="submit" className="submit-btn found-btn" disabled={isSubmitting}>
              {isSubmitting ? 'Reporting...' : '✅ Report Found'}
            </button>
            <button
              type="button"
